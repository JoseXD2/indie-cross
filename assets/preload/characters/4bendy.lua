local texture = 'nota/splashbendyn' 
...
function onStartCountdown()
    ...
    for i=1, 3 do
        addAnimationByPrefix('splashLeftCH', 'splash' ..i, 'color ' ..i, 24, false)
        addAnimationByPrefix('splashDownCH', 'splash' ..i, 'negro ' ..i, 24, false)
        addAnimationByPrefix('splashUpCH', 'splash' ..i, 'color ' ..i, 24, false)
        addAnimationByPrefix('splashRightCH', 'splash' ..i, 'negro ' ..i, 24, false)
    end
