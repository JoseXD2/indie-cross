local texture = 'nota/splashcupheddddd' 
...
function onStartCountdown()
    ...
    for i=1, 3 do
        addAnimationByPrefix('splashLeftCH', 'splash' ..i, 'note splash purple ' ..i, 24, false)
        addAnimationByPrefix('splashDownCH', 'splash' ..i, 'note splash blue ' ..i, 24, false)
        addAnimationByPrefix('splashUpCH', 'splash' ..i, 'note splash green ' ..i, 24, false)
        addAnimationByPrefix('splashRightCH', 'splash' ..i, 'note splash red ' ..i, 24, false)
    end
