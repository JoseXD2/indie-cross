function onCreate()
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'PapsNote' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'PapsNote'); --Change texture
...
local texture = 'nota/splashpapsn' 
