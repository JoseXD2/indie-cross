...
--ESPACIO
    ...
    if (canMove) then
        ...
        local kR = getMouseX('hud') > getProperty('cot4.x') and getMouseY('hud') > getProperty('cot4.y') and getMouseX('hud') < getProperty('cot4.x') + getProperty('cot4.width') and getMouseY('hud') < getProperty('cot4.y') + getProperty('cot4.height') and mousePressed() or getPropertyFromClass('flixel.FlxG', 'keys.pressed.D') or getPropertyFromClass('flixel.FlxG', 'keys.pressed.L') or
        ...
        local kL = getMouseX('hud') > getProperty('cot.x') and getMouseY('hud') > getProperty('cot.y') and getMouseX('hud') < getProperty('cot.x') + getProperty('cot.width') and getMouseY('hud') < getProperty('cot.y') + getProperty('cot.height') and mousePressed()
 or getPropertyFromClass('flixel.FlxG', 'keys.pressed.A') or getPropertyFromClass('flixel.FlxG', 'keys.pressed.J') or
        ...
        local kU = getMouseX('hud') > getProperty('cot3.x') and getMouseY('hud') > getProperty('cot3.y') and getMouseX('hud') < getProperty('cot3.x') + getProperty('cot3.width') and getMouseY('hud') < getProperty('cot3.y') + getProperty('cot3.height') and mousePressed()
 or getPropertyFromClass('flixel.FlxG', 'keys.pressed.W') or getPropertyFromClass('flixel.FlxG', 'keys.pressed.I') or
        ...
        local kD = getMouseX('hud') > getProperty('cot2.x') and getMouseY('hud') > getProperty('cot2.y') and getMouseX('hud') < getProperty('cot2.x') + getProperty('cot2.width') and getMouseY('hud') < getProperty('cot2.y') + getProperty('cot2.height') and mousePressed()
 or getPropertyFromClass('flixel.FlxG', 'keys.pressed.S') or getPropertyFromClass('flixel.FlxG', 'keys.pressed.K') or
